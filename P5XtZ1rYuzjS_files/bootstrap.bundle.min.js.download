            ...
            return r.toggle = function() { this._element.classList.contains("show") ? this.hide() : this.show() }, r.show = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (!B.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        ...
                        this._element.classList.remove("collapse"), this._triggerArray.length && this._triggerArray.forEach((function(t) { t.classList.remove("collapsed"), t.setAttribute("aria-expanded", !0) })), this.setTransitioning(!0);
                        var a = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                            l = u(this._element);
                        B.one(this._element, "transitionend", (function() { t._element.classList.remove("collapsing"), t._element.classList.add("collapse", "show"), t.setTransitioning(!1), B.trigger(t._element, "shown.bs.collapse") })), h(this._element, l)
                    }
                }
            }, r.hide = function() {
                var t = this;
                if (!this._isTransitioning && this._element.classList.contains("show") && !B.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                    ...
                    this._element.style[e] = this._element.classList.remove("collapse", "show");
